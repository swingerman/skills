...
THEMES=(pure powerline rainbow terminal panels catppuccin-mocha catppuccin-macchiato minimal)
...
echo
echo "Pick: pure | powerline | rainbow | terminal | panels | catppuccin-mocha | catppuccin-macchiato | minimal"
echo
